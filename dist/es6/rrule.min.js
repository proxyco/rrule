...
*
*/
const l=function(t,e=r){return new s.default(d(t,e)||void 0)},y=["count","until","interval","byweekday","bymonthday","bymonth"];h.IMPLEMENTED=[],h.IMPLEMENTED[s.default.HOURLY]=y,h.IMPLEMENTED[s.default.MINUTELY]=y,h.IMPLEMENTED[s.default.DAILY]=["byhour"].concat(y),h.IMPLEMENTED[s.default.WEEKLY]=y,h.IMPLEMENTED[s.default.MONTHLY]=y,h.IMPLEMENTED[s.default.YEARLY]=["byweekno","byyearday"].concat(y);const f=function(t,e,n,r){return new h(t,e,n,r).toString()},{isFullyConvertible:b}=h}])});