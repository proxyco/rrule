...
export declare const defaultKeys: ("bymonthday" | "freq" | "dtstart" | "dtend" | "dtvalue" | "dtfloating" | "interval" | "wkst" | "count" | "until" | "tzid" | "bysetpos" | "bymonth" | "bynmonthday" | "byyearday" | "byweekno" | "byweekday" | "bynweekday" | "byhour" | "byminute" | "bysecond" | "byeaster")[];
/**
 *
...
export default class RRule implements QueryMethods {
     ...
     */
    includes(dt: Date, inc?: boolean): boolean;
    /**
