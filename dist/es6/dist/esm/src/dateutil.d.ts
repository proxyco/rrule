...
export declare namespace dateutil {
    ...
    const toRfc5545DateTime: (time: number, utc?: boolean) => string;
    const toRfc5545Date: (time: number) => string;
    const fromRfc5545DateTime: (dt: string) => Date;
    const fromRfc5545Date: (dt: string) => Date;
}
